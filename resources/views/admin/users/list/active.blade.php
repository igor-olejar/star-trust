<x-admin-layout>
    <div class="max-w-6xl mx-auto my-12 px-6">
        <div class="flex flex-wrap items-end justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-slate-900">Active users</h1>
                <p class="text-slate-600 mt-1">Approved accounts with voting rights.</p>
            </div>
            <a
        ...
        <div class="mt-6 flex flex-wrap gap-2">
            ...
            <a href="{{ route('admin.users.list.active') }}" class="rounded-lg px-3 py-2 text-sm font-semibold bg-slate-900 text-white">Active</a>
        ...
        <div class="mt-8 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
                <p class="font-bold text-slate-900">Users (Active)</p>
